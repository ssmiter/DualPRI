...
pickle_file_path = f'Dataset/PSSM_394/pssm_s70.pkl'  # Replace with the correct path if necessary
output_directory = f'./Dataset/cons_s70'  # Replace with the correct path if necessary
